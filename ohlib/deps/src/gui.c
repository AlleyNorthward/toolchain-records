 ...
 * @retvalue   :None
******************************************************************************/   	  
void GUI_ShowString(u8 x,u8 y,u8 const *chr,u8 Char_Size,u8 mode)
{
 ...
 * @retvalue   :None
******************************************************************************/ 
void GUI_ShowFont16(u8 x,u8 y, const u8 *s,u8 mode)
{
	u8 i,j,k,tmp;
	u16 num;
  ...
  for(i=0;i<num;i++)
	{
		if((cfont16[i].Index[0]==*s)&&(cfont16[i].Index[1]==*(s+1))&&(cfont16[i].Index[2]==*(s+2)))
		{
			for(j=0;j<32;j++)
			{
				if(mode)
 ...
 * @retvalue   :None
******************************************************************************/ 
void GUI_ShowFont24(u8 x,u8 y, const u8 *s,u8 mode)
{
	u8 i,j,k,tmp;
	u16 num;
  ...
  for(i=0;i<num;i++)
	{
		if((cfont24[i].Index[0]==*s)&&(cfont24[i].Index[1]==*(s+1))&&(cfont24[i].Index[2]==*(s+2)))
		{
			for(j=0;j<72;j++)
			{
				if(mode)
 ...
 * @retvalue   :None
******************************************************************************/ 
void GUI_ShowFont32(u8 x,u8 y,u8 const*s,u8 mode)
{
	u8 i,j,k,tmp;
	u16 num;
  ...
  for(i=0;i<num;i++)
	{
		if((cfont32[i].Index[0]==*s)&&(cfont32[i].Index[1]==*(s+1))&&(cfont32[i].Index[2]==*(s+2)))
		{
			for(j=0;j<128;j++)
			{
				if(mode)
 ...
 * @retvalue   :None
******************************************************************************/	   		   
void GUI_ShowCHinese(u8 x,u8 y,u8 hsize,u8 const* str,u8 mode)
{ 
	while(*str!='\0')
	{
		if(hsize == 16)
