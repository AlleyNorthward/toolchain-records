...
void GUI_ShowString(u8 x,u8 y,const u8 *chr,u8 Char_Size,u8 mode);
void GUI_ShowFont16(u8 x,u8 y,const u8 *s,u8 mode);
void GUI_ShowFont24(u8 x,u8 y,const u8 *s,u8 mode);
void GUI_ShowFont32(u8 x,u8 y,const u8 *s,u8 mode);
void GUI_ShowCHinese(u8 x,u8 y,u8 hsize, const u8 *str,u8 mode);
